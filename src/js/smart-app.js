(function(window){
  window.extractData = function() {
    ...
    //alert("version ES-1104-window.location.rplace-CM-Baseline");
alert("version ES-1118-1window.location.href");	  
...
//var es_url = "https://usvadceapp.lcahncrls.net/cern-mutual-auth-service/b1930.lcahncrls.net/service/buildpostrequest?data=eyJwYXJhbWV0ZXJzIjp7ImVkaXBpIjoiMTIzNDUyIiwiaWNuIjoiMSIsIm5hbWUiOiJIaSBMZSIsImRvYiI6IjA5LTAxLTE5OTIiLCJzZXgiOiJNIiwiZmluIjoiMTQyMzQyMSIsIm1ybiI6IjI0MTQxMyJ9fSA=";	
//var es_url = "https://usvadceapp.lcahncrls.net/cern-mutual-auth-service/b1930.lcahncrls.net/service/buildpostrequest?data=eyJwYXJhbWV0ZXJzIjp7ImVkaXBpIjoiMSIsImljbiI6IjEiLCJuYW1lIjoiSGkgTGUiLCJkb2IiOiIwOS0yMy0xOTkyIiwic2V4IjoiTSIsImZpbiI6IjEyIiwibXJuIjoiNCJ9fSA=";  
      //console.log(es_url);
      alert(es_url);
      //window.open(es_url);
